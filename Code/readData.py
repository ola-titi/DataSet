...
if __name__ == '__main__':
    ...
    File = open('Train-Propaganda-English.csv', 'w', encoding="utf-8", newline='')
    with File:
    ...
    File = open('Dev-propaganda-English.csv', 'w', encoding="utf-8", newline='')
    with File:
        writer = csv.writer(File)
    ...
    File = open('Test-propaganda-English.csv', 'w', encoding="utf-8", newline='')
    with File:
        writer = csv.writer(File)
